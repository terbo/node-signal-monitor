...
wifiDevice.prototype.update = function(packet) {
  ...
  if(this.type == 'sta' && (!this.hosts.includes(packet.ssid)))
    ...
    if((this.mac != packet.src) && (!this.hosts.includes(packet.src)) || (this.mac != packet.dst) && (!this.hosts.includes(packet.dst)))
      this.hosts.push(packet.ssid)
  ...
  if(this.rssis && typeof this.rssis == 'array' && this.rssis.length > this.max_rssis)
